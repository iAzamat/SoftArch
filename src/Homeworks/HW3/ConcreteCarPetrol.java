...
public class ConcreteCarPetrol extends Car implements IGasStation {
    String brand;
    String model;
    Color color;
    BodyType bodyType;
     ...
     * @param engineVolume
     */
    public ConcreteCarPetrol(String brand,
                             String model,
                             Color color,
                             BodyType bodyType,
                             int numberWheels,
    ...
    public void fuelFilling(TypeFuel fuel, int volume) {
        if (this.fuelType == fuel) {
            System.out.printf("Машина: %s \nзаправлена на: %d л\n", (this.brand + " " + this.model), volume);
        } else {
