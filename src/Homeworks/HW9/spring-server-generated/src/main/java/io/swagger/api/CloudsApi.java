...
public interface CloudsApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Успешный ответ с заказом облака по ID"),
    ...
    ResponseEntity<Void> cancelCloudById(@Parameter(in = ParameterIn.PATH, description = "Индентификатор заказа облака", required=true, schema=@Schema()) @PathVariable("cloud_id") String cloudId);
    ...
    @Operation(summary = "Метод получения заказа на облако по ID", description = "", tags={ "Clouds" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Успешный ответ с заказом облака по ID", content = @Content(mediaType = "adplication/json", schema = @Schema(implementation = Cloud.class))),
    ...
    @RequestMapping(value = "/clouds/{cloud_id}",
        produces = { "adplication/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Cloud> getCloudById(@Parameter(in = ParameterIn.PATH, description = "Индентификатор заказа облака", required=true, schema=@Schema()) @PathVariable("cloud_id") String cloudId);
